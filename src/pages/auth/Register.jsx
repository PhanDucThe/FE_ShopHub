        ...
        <div className="flex-grow flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <Formik
            ...
            validationSchema={Yup.object({
              full_name: Yup.string().required("Vui lòng nhập họ tên đầy đủ"),
              email: Yup.string()
            ...
            {({ errors, touched, isSubmitting, handleSubmit }) => (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-6"
                >
                  {isSubmitting ? (
